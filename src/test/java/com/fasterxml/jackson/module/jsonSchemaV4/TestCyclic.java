...
public class TestCyclic extends SchemaTestBase {
    ...
    public void testListCyclic() throws Exception {
        ...
        String json = MAPPER.writeValueAsString(schema);
        String EXP = "{\"id\":\"#com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop\",\"type\":\"object\",\"definitions\":{\"com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop\":{\"id\":\"#com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop\",\"type\":\"object\",\"properties\":{\"list\":{\"$ref\":\"#/definitions/java:util:List(com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop)\"}}},\"java:util:List(com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop)\":{\"id\":\"#java:util:List(com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop)\",\"type\":\"array\",\"items\":{\"$ref\":\"#/definitions/com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop\"}}},\"properties\":{\"list\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/definitions/com:fasterxml:jackson:module:jsonSchemaV4:TestCyclic:ListLoop\"}}}}";
