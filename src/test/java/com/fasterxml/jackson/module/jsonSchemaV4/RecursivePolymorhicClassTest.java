...
public class RecursivePolymorhicClassTest {
    ...
    public void noStackOverFlow() {
        JsonSchema schema = Utils.schema(B.class);
        System.out.println(Utils.toJson(schema, schema.getClass()));
    }
    ...
    public void validateTest() throws Exception {
        ...
        String jsonInText = Utils.toJson(b3, b3.getClass());
        System.out.println(jsonInText);
        com.github.fge.jsonschema.main.JsonSchema validatorSchema = Utils.createValidatorSchemaForClass((B.class));
