...
public class TestTypeGeneration extends SchemaTestBase {
    ...
    public void testCorrectType() throws Exception {
        ...
        final String EXP = "{'id':'urn:com:fasterxml:jackson:module:jsonSchemaV4:TestTypeGeneration:Issue14Bean','type':'object','properties':{'date':{'type':'integer','format':'utc-millisec'}}}";
